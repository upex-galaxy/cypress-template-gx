...
- Si se realiza una tarea completa con POM, CI y Cucumber correctamente, es motivo para que subir a Nivel 2 automáticamente mediante un Challenge (una nueva US asignada).
___
- ### 🚩LEVEL TWO (L2):
